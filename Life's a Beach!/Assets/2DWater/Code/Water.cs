...
namespace Bundos.WaterSystem
{
    ...
    public class Water : MonoBehaviour
    {
        ...
        {
            if (other.TryGetComponent(out ISubmergeable submergeable) && !submergeable.IsUnderwater &&
                other.bounds.max.y < Collider.bounds.max.y)
            {
                submergeable.IsUnderwater = true;
            }
        }
        ...
        void OnTriggerExit2D(Collider2D other)
        {
            ...
            if (other.TryGetComponent(out ISubmergeable submergeable))
            {
                submergeable.IsUnderwater = false;
            }
        }
